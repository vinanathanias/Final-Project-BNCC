...
//	JFrame insertFrame;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==insertButton) {
			...
			insertFrame.setDefaultCloseOperation(EXIT_ON_CLOSE);
			...
			kodeLabel.setBounds(50,100,150,30);
			
			kodeField = new JTextField();
			kodeField.setBounds(150, 100, 150, 30);
			...
			namaLabel.setBounds(50, 150, 150, 30);
		
			namaField = new JTextField();
			namaField.setBounds(150, 150, 150, 30);
			...
			hargaLabel.setBounds(50,200,150,30);
			
			hargaField = new JTextField();
			hargaField.setBounds(150, 200, 150, 30);
		...
		if(e.getSource()==viewButton) {
			...
			viewFrame.setLayout(null); // gapake layout
		...
		if(e.getSource()==updateButton) {
			...
			//=========================================
			namaLabel = new JLabel("Nama Menu :");
			namaLabel.setBounds(50, 100, 150, 30);
		
			namaField = new JTextField();
			namaField.setBounds(150, 100, 150, 30);
			updateFrame.add(namaLabel);
			updateFrame.add(namaField);
			//==========================================
			
			hargaLabel = new JLabel("Harga Menu : Rp ");
			hargaLabel.setBounds(50,150,150,30);
			
			hargaField = new JTextField();
			hargaField.setBounds(150, 150, 150, 30);
			...
			stokLabel = new JLabel("Jumlah Stok : ");
			stokLabel.setBounds(50,200,150,30);
			
			stokField = new JTextField();
			stokField.setBounds(150, 200, 150, 30);
			...
			subupdateButton.setBounds(200, 250, 100, 30);
